...
export const metadata: Metadata = {
  title: 'Privacy Policy | Mahadev Aromatics',
  description: 'Privacy policy for Mahadev Aromatics - Learn how we protect your personal information.',
}

export default function PrivacyPolicyPage() {
  const policy = DEFAULT_POLICIES.privacy
